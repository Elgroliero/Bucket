...
#[UniqueEntity(fields: ['name'], message: 'Il existe déjà une catégorie avec ce nom', errorPath: 'name')]
class Category
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(name: 'category', type: Types::STRING, length: 50, unique: true, nullable: true)]
